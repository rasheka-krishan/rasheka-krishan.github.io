...
function sadFunction() {
  ...
  var element = document.getElementById("secondtolastletter");
  element.classList.toggle("sadsecondtolastletter");

  var element = document.getElementById("thirdtolastletter");
  element.classList.toggle("sadthirdtolastletter");
...
function loveFunction(){
  ...
  var element = document.getElementById("secondletter");
  element.classList.toggle("lovesecondletter");

  var element = document.getElementById("thirdletter");
  element.classList.toggle("lovethirdletter");

  var element = document.getElementById("thirdtolastletter");
  element.classList.toggle("lovethirdtolastletter");

  var element = document.getElementById("secondtolastletter");
  element.classList.toggle("lovesecondtolastletter");

  var element = document.getElementById("lastletter");
  element.classList.toggle("lovelastletter");
